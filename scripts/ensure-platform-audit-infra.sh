...
PLATFORM_AUDIT_CONNECT_MAX_RETRIES="${PLATFORM_AUDIT_CONNECT_MAX_RETRIES:-60}"
PLATFORM_AUDIT_CONNECT_RETRY_SECONDS="${PLATFORM_AUDIT_CONNECT_RETRY_SECONDS:-5}"
PLATFORM_AUDIT_CONNECTOR_MAX_RETRIES="${PLATFORM_AUDIT_CONNECTOR_MAX_RETRIES:-60}"
PLATFORM_AUDIT_CONNECTOR_RETRY_SECONDS="${PLATFORM_AUDIT_CONNECTOR_RETRY_SECONDS:-5}"
...
wait_for_connect "${PLATFORM_AUDIT_CONNECT_MAX_RETRIES}" "${PLATFORM_AUDIT_CONNECT_RETRY_SECONDS}"
if [[ "${VERIFY_ONLY}" == "false" ]]; then
  upsert_connector
fi
wait_for_connector_running "${PLATFORM_AUDIT_CONNECTOR_MAX_RETRIES}" "${PLATFORM_AUDIT_CONNECTOR_RETRY_SECONDS}"
